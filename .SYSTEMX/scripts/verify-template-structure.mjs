...
const requiredDirs = [
  ...
  '.SYSTEMX/KIT/Brand',
  '.SYSTEMX/LAN',
  '.SYSTEMX/LAN/Research',
  '.SYSTEMX/LAN/Research/Webflow',
  '.SYSTEMX/LAN/Research/Webflow/sources',
  '.SYSTEMX/LAN/Research/Webflow/planning',
  '.SYSTEMX/LAN/Research/Webflow/Package-Schemas',
  '.SYSTEMX/LAN/Research/Webflow/INJECT',
  '.SYSTEMX/LAN/Website',
  '.SYSTEMX/LAN/Builder',
...
const requiredFiles = [
  ...
  '.SYSTEMX/LAN/tests/characterization.test.mjs',
  '.SYSTEMX/scripts/validate-markdown-links.mjs',
  '.SYSTEMX/LAN/Builder/contracts/designer-document.schema.json',
  '.SYSTEMX/LAN/Builder/contracts/designer-command.schema.json',
  '.SYSTEMX/LAN/Builder/contracts/designer-style.schema.json',
  '.SYSTEMX/LAN/Builder/contracts/capability-manifest.json',
  '.SYSTEMX/LAN/Builder/contracts/designer-component.schema.json',
  '.SYSTEMX/LAN/Builder/contracts/designer-cms.schema.json',
  '.SYSTEMX/LAN/Builder/contracts/designer-evidence.schema.json',
  '.SYSTEMX/LAN/Builder/contracts/designer-publish-manifest.schema.json',
  '.SYSTEMX/LAN/Builder/contracts/designer-plugin.schema.json',
  '.SYSTEMX/LAN/Builder/contracts/designer-presence.schema.json',
  '.SYSTEMX/LAN/WEBFLOW-DEEP-RESEARCH-MASTER-PLAN.md',
  '.SYSTEMX/LAN/Research/Webflow/SCHEMA-DECISIONS.md',
  '.SYSTEMX/LAN/Research/Webflow/WAVE-0-EVIDENCE.md',
  '.SYSTEMX/Template/steps/04-env-and-secrets.md',
  '.SYSTEMX/LAN/Research/Webflow/00-EXECUTIVE-SUMMARY.md',
  '.SYSTEMX/LAN/Research/Webflow/20-IMPLEMENTATION-MASTER-PLAN.md',
  '.SYSTEMX/LAN/Research/Webflow/RESEARCH-PACKAGE-README.md',
  '.SYSTEMX/LAN/Research/Webflow/RESEARCH-PACKAGE-VALIDATION.md',
  '.SYSTEMX/LAN/Research/Webflow/sources/SOURCE-CATALOG-200.csv',
  '.SYSTEMX/LAN/Research/Webflow/sources/SOURCE-CATALOG-200.json',
  '.SYSTEMX/LAN/Research/Webflow/planning/ROADMAP.csv',
  '.SYSTEMX/LAN/Research/Webflow/planning/BACKLOG.csv',
  ...
  'wiki/Update-Log.md',
  'wiki/SYSTEMX-LAN-Webflow-Master-Plan.md',
  'wiki/_Sidebar.md',
  'package.json',
  'firebase.json',
  'firestore.rules',
