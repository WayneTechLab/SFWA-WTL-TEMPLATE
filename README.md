...
Root agent files are intentionally small. Canonical AI instructions and vendor
adapter source now live under `.SYSTEMX/AI/`; `AGENTS.md`, `CLAUDE.md`,
`GEMINI.md`, `.github/copilot-instructions.md`, `.amazonq/rules/systemx.md`,
and similar tool-required paths are discovery stubs generated by
`npm run wtl:sync`.
